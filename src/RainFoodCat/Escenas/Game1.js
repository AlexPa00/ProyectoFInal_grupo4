 import Phaser from "phaser";
  ...
  //Agregacion de constantes
    ...
    export var Game1 = new Phaser.Class({
    ...
    initialize:
        ...
        function Game1() {
         ...
         preload(){
            ...
            this.load.image('city','Images/CatFoodRain/Catimages/City.png');
            this.load.atlas("cat","/Images/CatFoodRain/Catimages/gatos.png","/Images/CatFoodRain/Catimages/sprites.json");
            this.load.spritesheet("eat","/Images/CatFoodRain/Catimages/EatCatCat1.png",{frameWidth: 45.25,frameHeigth: 47});
            ...
            this.load.audio('nivel1','/Sounds/Catsounds/Nivel1.0.mp3');
        },
