    ...
    initialize:
        ...
        function Game2() {
         ...
         preload(){
            ...
            this.load.image('city2','images/LV2.png');
            this.load.atlas("cat","/images/gatos.png","/images/sprites.json");
            this.load.spritesheet("eat1","/images/EATCatCat3.png",{frameWidth: 45.11,frameHeigth: 48});
            ...
            this.load.audio('nivel2','/sounds/Nivel2.0.mp3');
        },
